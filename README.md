# InitOpenGL - `Lab3-2_ColorTriangle_ShadersGLSLIndexBuffers`

This repository is a **Visual Studio C++ OpenGL** course project. Work is organized across **many Git branches**; you are viewing **`Lab3-2_ColorTriangle_ShadersGLSLIndexBuffers`**. For the **complete branch index**, lab sequence, build notes, and lighting overview, see the canonical README on **`master`**.
