# InitOpenGL - `Lab4-2_TexturesFilteringMipMaps`

This repository is a **Visual Studio C++ OpenGL** course project. Work is organized across **many Git branches**; you are viewing **`Lab4-2_TexturesFilteringMipMaps`**. For the **complete branch index**, lab sequence, build notes, and lighting overview, see the canonical README on **`master`**.
...
Iteration on **Lab4-1**: adjusts **filtering / mipmapping** behavior in `Texture.cpp` and related sampling setup.
