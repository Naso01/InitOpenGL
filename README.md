# InitOpenGL - `Lab7-3_TBN-instancing_NormalMapsInstancing`

This repository is a **Visual Studio C++ OpenGL** course project. Work is organized across **many Git branches**; you are viewing **`Lab7-3_TBN-instancing_NormalMapsInstancing`**. For the **complete branch index**, lab sequence, build notes, and lighting overview, see the canonical README on **`master`**.
