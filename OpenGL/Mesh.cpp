...
void Mesh::Create(Shader* _shader) {
	...
	glm::vec3 yuv = glm::vec3(0.0f, 0.0f, 0.0f) * yuvMatrix;
	...
	glm::vec3 rgb =  glm::vec3(0, +0.2, -0.2) * rgbMatrix ;

	m_vertexData = {
		// Position 			RGB Color 		Texture Coords 
		50.0f, 50.0f, 0.0f,		 1 + rgb.r, rgb.g, rgb.b,	1.0f, 1.0f,	// top-right
		50.0f, -50.0f, 0.0f,	 rgb.r, 1+ rgb.g, rgb.b,	1.0f, 0.0f,	// bottom-right
		-50.0f, -50.0f, 0.0f,	 rgb.r, rgb.g, 1 +rgb.b,	0.0f, 0.0f,	// bottom-left
		-50.0f, 50.0f, 0.0f,	 1 + rgb.r, 1 + rgb.g, 1 + rgb.b,	0.0f, 1.0f	// top-left
	};
	*/
/**/
	...
	m_vertexData = {
		...
		50.0f, 50.0f, 0.0f,		 1, 0, 0,	1.0f, 1.0f,	// top-right
		50.0f, -50.0f, 0.0f,	 0, 1, 0,	1.0f, 0.0f,	// bottom-right
		-50.0f, -50.0f, 0.0f,	 0, 0, 1,	0.0f, 0.0f,	// bottom-left
		-50.0f, 50.0f, 0.0f,	 1, 1, 1,	0.0f, 1.0f	// top-left
	};
